...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMenu3TextView.setText("\n*Ingredients\n\n" +
                "2 teaspoons ," + "olive oil2 ,"+ "pounds Italian sausage," + "large potatoes," +" peeled and thickly sliced2 large green bell peppers,\n"+
                "seeded and cut into wedges2 large red bell peppers," + "Coconut \n\n" +
                "* Directions\n" +
